...
def main():
    ...
    pretrain_model_dir = '/export/home/Dataset/fine_tune_Bert_stored/FineTune_MNLI_FEVER_SciTail_SICK_RTE' #FineTuneOnCombined'# FineTuneOnMNLI, FineTuneOnFEVER, FineTuneOnRTE
