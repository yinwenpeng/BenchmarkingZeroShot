...
def main():
    ...
    if args.do_train:
        ...
        train_examples, seen_types = processor.get_examples_Yahoo_train('/export/home/Dataset/YahooClassification/yahoo_answers_csv/zero-shot-split/train_pu_one_wo_1.txt', 130000) #train_pu_half_v1.txt
