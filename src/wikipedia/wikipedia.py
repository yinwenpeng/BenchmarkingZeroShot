...
def summary(title, sentences=0, chars=0, auto_suggest=True, redirect=True):
    ...
    * redirect - allow redirection without raising RedirectError
    ...
    if page_info == 'invalidreturn':
        return '............'
    else:
        if page_info.valid is False:
            return '............'
        else:
            ...
            request = _wiki_request(query_params) #the core step to retrieve from wikipedia given query parameters
