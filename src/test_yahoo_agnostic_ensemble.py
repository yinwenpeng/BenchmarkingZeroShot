...
def main():
    ...
    for model_i, modelpath in enumerate(modelpaths):
        ...
        seen_acc, unseen_acc = evaluate_Yahoo_zeroshot_TwpPhasePred(pred_probs_i, pred_binary_labels_harsh, pred_binary_labels_loose, test_label_list, test_hypo_seen_str_indicator, test_hypo_2_type_index, seen_types)
